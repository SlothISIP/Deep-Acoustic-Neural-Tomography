...
Scene~12 (two parallel plates, IoU\,=\,0.49), where the smooth-minimum
...
The auto-decoder inverse model with Eikonal regularization achieves 0.95 mean IoU, and cycle-consistency provides
